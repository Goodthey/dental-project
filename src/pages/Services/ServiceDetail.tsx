        ...
        <div className="container-custom relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            >
              <Link
                to="/contacts"
                className="group inline-flex items-center gap-2 rounded-xl bg-accent px-6 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-accent-hover hover:shadow-glow-accent active:scale-[0.98]"
              >
                Обсудить проект
